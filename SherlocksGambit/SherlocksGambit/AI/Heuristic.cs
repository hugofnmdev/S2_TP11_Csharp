...
namespace SherlocksGambit.AI
{
    public static class Heuristic
    {
        ...
        { 
            ...
            var playerPieces = board.PieceManager.PiecesDictionary[currPlayer];

            // Get the opponent's pieces
            var opponentPieces = board.PieceManager.PiecesDictionary[currPlayer.Opposite()];
            
            // Get the player's pieces' value
            var playerValue = playerPieces.Count(piece => playerPieces.Count[piece.]);
            
            // Get the opponent's pieces' value
            var opponentValue = opponentPieces.Count(piece => piece.Value);
        ...
        public static double ComputeHeuristic(Board board, PlayerColor currPlayer)
        {
            ...
            // Get the player's pieces' value
            var playerValue = playerPieces.Count(piece => playerPieces.Contains(piece));
